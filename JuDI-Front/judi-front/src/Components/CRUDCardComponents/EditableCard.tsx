...
class EditableCard extends React.Component<EditableCardProps, IEditableCardState> {
    ...
    render() : React.ReactElement<any, string | React.JSXElementConstructor<any>> | string | number | {} | React.ReactNodeArray | React.ReactPortal | boolean | null | undefined{
        ...
        return (
            <div className="mb-3 p-4" style={{boxShadow: '0 0 10px #ccc', margin: "0px auto", alignItems:"center", alignContent:"center", border:"solid", borderRadius:5, borderColor:"#a7a7a7"}} >
                {
